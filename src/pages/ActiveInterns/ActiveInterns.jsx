...
function ActiveInterns({ companyUsers, currUser, setCompanyUsers, addNotification }) {
  ...
  const activeInterns = companyData?.internships?.flatMap(internship => 
    (internship.applications || [])
      .filter(application => application.internshipStatus === "currentIntern")
      .map(application => ({
        ...application,
  ...
  const handleMarkAsCompleted = (intern) => {
    ...
    if (window.confirm(`Are you sure you want to mark ${intern.firstName} ${intern.lastName}'s internship as completed?`)) {
            ...
            return {
              ...
              applications: (internship.applications || []).map(application => {
                ...
                if (application.username === intern.username) {
                  console.log("Found matching application:", application.username);
                  return { 
                    ...application, 
      ...
      addNotification(`${intern.firstName} ${intern.lastName} has completed their internship!`, "success");
  ...
  return (
    <div className="active-interns-container">
            ...
            >
              <div className="intern-info">
                ...
                <div className="intern-details">
                  <p><strong>Current Internship:</strong> {intern.internshipTitle}</p>
                  <p><strong>Email:</strong> {intern.email}</p>
                  <p><strong>Duration:</strong> {intern.internshipDuration}</p>
                </div>
                <div className="intern-skills">
                  {intern.skills && intern.skills.map((skill, index) => (
                ...
                <div className="intern-actions">
                  ...
                  <button 
                    onClick={() => navigate(`/viewApplications/${intern.internshipId}/applicant/${intern.username}`)}
      ...
      <div className="navigation-buttons">
        <button onClick={() => navigate('/completed-interns')} className="view-completed-button">
