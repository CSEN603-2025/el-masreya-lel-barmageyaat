  ...
  const interns = useMemo(() => {
    return filteredInternships.flatMap((internship) =>
      (internship.applications || [])
        .filter(
          (app) =>
            app.internshipStatus === "currentIntern" ||
      ...
      <div className="view-toggle">
        <button
          className={`toggle-button ${
            currentView === "internships" ? "active" : ""
          }`}
          ...
          {filteredInternships.length > 0 ? (
            filteredInternships.map((internship) => (
              <div key={internship.internshipID} className="internship-card">
                ...
                <p>
                  <strong>Industry:</strong> {internship.industry}
                </p>
                <p>
          ...
          {interns.length > 0 ? (
            interns.map((intern) => (
              ...
              >
                <div className="intern-header">
                  ...
                  <span
                    className={`status-badge ${
                      intern.internshipStatus === "currentIntern"
                        ? "current"
                        : "past"
                    }`}
                  >
                ...
                <p>
                  <strong>Intern Username:</strong> {intern.username}
                </p>
                <p>
