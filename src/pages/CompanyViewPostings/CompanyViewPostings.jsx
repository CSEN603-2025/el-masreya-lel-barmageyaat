...
function CompanyViewPostings({
      ...
      if (selectedInternship === "all") {
        ...
        setFilteredInternships(
          currUser.internships.filter(
            (internship) =>
              internship.internshipID === parseInt(selectedInternship)
          )
        );
      }
    }
  ...
  if (!currUser) {
    return (
      <div className="loading-message">
        Please log in to view your company dashboard.
      </div>
    );
  }
  ...
  const totalApplications =
    currUser.internships?.reduce(
      (total, internship) => total + getTotalApplications(internship),
      0
    ) || 0;
  ...
  return (
    <div className="company-dashboard">
      ...
      <div className="company-info">
        <h2>{currUser.name}</h2>
        <p>
          <strong>Industry:</strong> {currUser.industry || "Not specified"}
        </p>
        <p>
          <strong>Size:</strong> {currUser.Size || "Not specified"}
        </p>
        <p>
          <strong>Email:</strong> {currUser.email || "Not specified"}
        </p>
      </div>
      ...
      <div className="dashboard-actions">
        ...
        <Link
          to="/active-interns"
          className="action-button view-active-interns"
        >
      ...
      <div className="internship-filter-section">
        ...
        <div className="filter-controls">
          ...
          >
            <option value="all">
              All Internships ({totalApplications} total applications)
            </option>
            {currUser.internships?.map((internship) => (
              ...
              >
                {internship.title} ({getTotalApplications(internship)}{" "}
                applications)
              </option>
            ))}
          </select>
      ...
      <div className="email-notification-alert">
        <div className="email-notification-content">
          ...
          <div className="email-info">
            ...
            <p>
              You will receive email notifications when students apply to your
              internships.
            </p>
          </div>
        </div>
          ...
          filteredInternships.map((internship, index) => (
            <div key={index} className="internship-listing-container">
              ...
              <div className="internship-stats">
                ...
                <Link
                  to={`/viewApplications/${internship.internshipID}`}
        ...
        <div className="email-list">
          ...
          <div className="email-preview">
            <p className="email-recipient">
              To: {currUser.email || currUser.username}
            </p>
            <p className="email-subject">
              Subject: Welcome to El-Masreya-Lel-Barmageyaat!
            </p>
